...
class RankedPanel extends React.Component {
    ...
    render() {
        ...
        const soloRank = (this.props.ranking?.RANKED_SOLO_5x5?.pos || -1) !== -1 ? `Rank: ${this.props.ranking.RANKED_SOLO_5x5.pos.toString()} / ${this.props.ranking.RANKED_SOLO_5x5.total.toString()}` : 'not ranked';
        const flexRank = (this.props.ranking?.RANKED_FLEX_SR?.pos || -1) !== -1 ? `Rank: ${this.props.ranking.RANKED_FLEX_SR.pos.toString()} / ${this.props.ranking.RANKED_FLEX_SR.total.toString()}` : 'not ranked';
